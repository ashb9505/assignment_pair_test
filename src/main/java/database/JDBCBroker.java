...
public class JDBCBroker
{
	...
	// DB Access data
	private String dbName = "spr23_csc429_ahoan1";
	private String username = "ahoan1";
	private String password = "_spr23_0";
	private String server = "csdb.brockport.edu";

	private String dbClassNameVal = "org.mariadb.jdbc.Driver";
	private String dbInstallationNameVal = "mariadb";
